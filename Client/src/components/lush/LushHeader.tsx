...
import LazyIcon from '../shared/LazyIcon';
...
import type { HeaderProps } from '../../pages/Header';
...
/**
 * Lush theme's header. Single row, sticky, one hamburger -> one full-screen
 * menu — kept as its own component rather than more isLushTheme branches on
 * Header.tsx, since Lush's layout structurally diverges (inline nav vs.
 * Header.tsx's centered-logo + dual-drawer layout) rather than just reskinning.
 */
export default function LushHeader({ onNavigate }: HeaderProps) {
