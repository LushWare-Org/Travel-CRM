    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 pt-10">
        <div className="flex justify-center mb-16 px-4 sm:px-0">
          <div className="inline-flex bg-white border border-gray-200 rounded-2xl p-2 gap-2 flex-col sm:flex-row w-full sm:w-auto">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        {/* Tab Content */}
        <div className="bg-white border border-gray-200 rounded-3xl p-6 sm:p-10 md:p-12 mb-20 mx-4 sm:mx-0">
          {activeTab === 'story' && (
            <div>
          ...
          {activeTab === 'mission' && (
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-brand-50 border border-gray-200 p-8 rounded-2xl">
              ...
              <div className="bg-brand-accent-50 border border-gray-200 p-8 rounded-2xl">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, idx) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-white border border-gray-200 hover:border-gray-300 transition-all duration-500">
                  {/* Image Container */}
