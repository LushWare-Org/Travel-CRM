  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-3xl shadow-lg border border-gray-200 overflow-hidden mb-8">
          <div className="relative h-64 md:h-80">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 md:p-12">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-3">{pkg.title}</h1>
              ...
              <div className="flex flex-wrap items-center gap-6 mt-4">
                <div className="bg-white/20 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/30">
                  <p className="text-xs text-white/80 uppercase tracking-wide mb-1">Duration</p>
                  <p className="text-2xl font-bold text-white">{pkg.duration_days} Days</p>
                </div>
                <div className="bg-white/20 backdrop-blur-sm rounded-xl px-6 py-3 border border-white/30">
                  <p className="text-xs text-white/80 uppercase tracking-wide mb-1">From</p>
                  <p className="text-2xl font-bold text-white">{formatCurrency(pkg.price_from)}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-orange-500 to-amber-600 rounded-2xl p-6 md:p-8 mb-8 text-white shadow-xl">
          ...
          <form onSubmit={handleSubmit} noValidate className="p-6 lg:p-8">
                    ...
                    {[1, 2, 3, 4, 5].map((step) => (
                      <div key={step} className="flex items-center flex-1">
                        <div className="flex flex-col items-center flex-1">
                          ...
                          <span className={`text-xs mt-2 font-medium ${currentStep >= step ? 'text-black' : 'text-gray-400'}`}>
                            {step === 1 && 'Contact'}
                            {step === 2 && 'Travel'}
                            {step === 3 && 'Itinerary'}
                            {step === 4 && 'Notes'}
                ...
                {currentStep === 1 && (
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-black mb-1">How can we reach you?</h3>
                      <p className="text-sm text-black/60 mb-6">We'll send your customized itinerary to your email</p>
                      
                      <div className="space-y-4">
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-sm font-medium text-black">What's your name?</span>
                          ...
                          <input
                            ...
                            className="w-full px-5 py-4 text-lg border-2 border-black/10 rounded-2xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200 bg-white shadow-sm hover:shadow-md"
                        ...
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-sm font-medium text-black">What's your email?</span>
                          ...
                          <input
                            ...
                            className="w-full px-5 py-4 text-lg border-2 border-orange-500/30 rounded-2xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200 bg-white shadow-sm hover:shadow-md"
                ...
                {currentStep === 2 && (
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-black mb-1">Tell us about your trip</h3>
                      <p className="text-sm text-black/60 mb-6">Help us personalize your experience</p>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-white rounded-2xl p-5 border-2 border-black/5 hover:border-orange-500/30 transition-all shadow-sm hover:shadow-md">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              <label className="text-sm font-semibold text-black">Travelers</label>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 text-lg border-2 border-black/10 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all bg-white"
                            placeholder="2"
                          />
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-5 border-2 border-black/5 hover:border-orange-500/30 transition-all shadow-sm hover:shadow-md">
                          <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                              <label className="text-sm font-semibold text-black">Preferred Date</label>
                ...
                {currentStep === 3 && (
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                        <div>
                          <h3 className="text-xl font-bold text-black mb-1">Customize your daily adventures</h3>
                          <p className="text-sm text-black/60">
                        ...
                        <button
                          ...
                          className="px-5 py-3 text-sm font-bold text-white rounded-xl bg-orange-600 hover:bg-orange-700 shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2 whitespace-nowrap"
                        >
                  ...
                  <div className="space-y-5">
                    {dayOverrides.map((day, index) => (
                      <div key={day.id} className="border border-gray-200 rounded-2xl p-6 bg-gradient-to-br from-white to-gray-50/50 shadow-sm hover:shadow-md transition-all duration-200">
                        <div className="flex items-center justify-between mb-5">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-xl bg-orange-600 text-white font-bold text-lg flex items-center justify-center shadow-md">
                              {index + 1}
                            </div>
                            <div>
                              <h3 className="text-lg font-semibold text-black">Day {index + 1}</h3>
                              {day.title && day.title !== `Day ${index + 1}` && (
                                <p className="text-sm text-black/70 mt-0.5">{day.title}</p>
                              )}
                            </div>
                          </div>
                          <button
                            ...
                            className="px-3 py-1.5 text-sm font-medium text-black hover:text-orange-600 hover:bg-orange-50 rounded-lg transition-colors duration-200"
                          >
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {!dayOverrides.length && (
                      <div className="border-2 border-dashed border-black/20 rounded-2xl p-12 text-center bg-gradient-to-br from-white to-orange-50/30">
                        ...
                        <p className="text-black font-medium mb-2">No itinerary days added yet</p>
                        <p className="text-sm text-black/70 mb-4">Click "Add Day" to start building your customized itinerary</p>
                        <button
                          type="button"
                          onClick={handleAddDay}
                          className="px-6 py-2.5 text-sm font-semibold text-white rounded-xl bg-orange-600 hover:bg-orange-700 shadow-md hover:shadow-lg transition-all duration-200"
                        >
                          Add Your First Day
                        </button>
                      </div>
                ...
                {currentStep === 4 && (
                  <div className="mb-10">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div className="flex-1">
                        <h3 className="text-xl font-bold text-black mb-1">Anything else we should know?</h3>
                        <p className="text-sm text-black/60 mb-4">Special occasions, dietary needs, accessibility requirements, or travel style preferences</p>
                        <textarea
                          rows={5}
                          value={message}
                          onChange={(e) => setMessage(e.target.value)}
                          className="w-full px-5 py-4 text-base border-2 border-black/10 rounded-2xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200 resize-none bg-white shadow-sm hover:shadow-md"
                  ...
                  <div className="mb-10">
                    <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-3xl p-8 border-2 border-orange-200">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-black mb-1">Review Your Request</h3>
                          <p className="text-sm text-black/70">Everything looks good? Submit and we'll get started!</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-4 mb-8">
                        ...
                        {dayOverrides.length > 0 && (
                          <div className="bg-white rounded-xl p-5 border border-black/10">
                            ...
                            <p className="text-sm"><span className="font-medium">{dayOverrides.length}</span> day(s) customized</p>
                          </div>
                        )}
                      ...
                      <div className="bg-gradient-to-br from-orange-500 via-orange-600 to-amber-600 rounded-2xl p-6 text-white">
                        <div className="flex items-center gap-3 mb-4">
                          <CheckCircle2 className="w-8 h-8" />
                          <h4 className="text-xl font-bold">Ready to create your perfect trip?</h4>
                        </div>
                        <p className="text-orange-50 mb-6">
                          Our travel experts will review your preferences and send you a personalized itinerary within 24 hours.
                        </p>
                        <div className="flex flex-wrap gap-3 text-sm text-orange-50 mb-6">
                        ...
                        <button
                          ...
                          className="w-full px-8 py-4 rounded-2xl font-bold text-lg text-orange-600 bg-white shadow-xl hover:shadow-2xl transition-all duration-200 flex items-center justify-center gap-3 hover:scale-105 transform disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                          {isSubmitting ? (
                            <>
                ...
                <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200">
                  ...
                  {currentStep < totalSteps ? (
                    <button
                      ...
                      className="px-6 py-3 rounded-xl font-semibold text-white bg-orange-600 hover:bg-orange-700 shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
                    >
                      Next
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
