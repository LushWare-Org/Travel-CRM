                  ...
                  >
                    <div className="group relative bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full border border-gray-100">
                     ...
                     <div className="relative h-64 sm:h-56 md:h-64 overflow-hidden">
                      ...
                      <div className="p-6 sm:p-4 bg-white">
                        <h3 className="text-[#001d3d] font-bold text-lg sm:text-lg mb-4 sm:mb-3 line-clamp-2 leading-tight font-poppins group-hover:text-orange-600 transition-colors duration-300">
                          {item.packageName}
                        </h3>
                        <div className="text-sm text-gray-600 mb-6 sm:mb-4">
