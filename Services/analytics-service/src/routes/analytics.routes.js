...
router.get('/packages/overview', requireAuth, authorize('admin', 'salesRep'), validateOverviewQuery, analyticsController.getPackageAnalyticsOverview);
...
router.get('/website/overview', requireAuth, authorize('admin', 'salesRep'), validateOverviewQuery, analyticsController.getWebsiteAnalyticsOverview);
