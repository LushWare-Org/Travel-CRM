...
const WebsiteUsersTable = ({ users, onEdit, onDelete, onToggleStatus }) => {
  return (
              ...
              <td className="px-4 py-3 text-sm">
                <div className="flex gap-2">
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${user.status === 'active' ? 'hover:bg-red-100 text-red-600' : 'hover:bg-green-100 text-green-600'}`}
